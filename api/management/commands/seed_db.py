...
class Command(BaseCommand):
    ...
    def handle(self, *args, **options):
        ...
        users_data = [
            ...
            {'id': 'u4', 'username': 'student_alice', 'role': 'STUDENT', 'credit_score': 750, 'bio': 'CS Major.'},
            {'id': 'u5', 'username': 'student_bob', 'role': 'STUDENT', 'credit_score': 680, 'bio': 'Selling guitar.'},
        ...
        for u in users_data:
            ...
            User.objects.create_user(
                ...
                role=u['role'],
                is_staff=is_admin,  # 只有设为 True 才能访问 admin_list
                is_superuser=is_admin,  # 提升权限
